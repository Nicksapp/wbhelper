...
class NeiCommand extends Command {
  ...
  async handleFileGenerate(targetData) {
    ...
    fileGenerator.isTargetFolderExist(path.resolve(cwd, nei_config.controller_placement))
    fileGenerator.isTargetFolderExist(path.resolve(cwd, nei_config.service_placement))
    fileGenerator.isTargetFolderExist(path.resolve(cwd, nei_config.api_placement))
